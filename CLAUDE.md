...
5. `docs/UX_DESIGN.md` — screen-by-screen design system (color, type, motion, wireframes) for the Flutter client. **Every screen in §2 is implemented except Pantalla 6** (Simulación en vivo), which needs a pipeline-progress WebSocket the backend doesn't expose — see `app/`.
